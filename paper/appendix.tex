...
Most results are formalized in Lean~4 with Mathlib. The accompanying implementation consists of four Python modules and a machine-readable result file. Running
\begin{verbatim}
